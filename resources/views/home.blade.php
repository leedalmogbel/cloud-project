    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">EIEV CLINIC</a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="d-flex">
                        <button class="btn btn-outline-warning" type="submit">Book Appointment</button>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="5000">
                    <img src="/assets/images/horse1_1920.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="/assets/images/horse2_1920.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img src="/assets/images/horse3_1920.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
