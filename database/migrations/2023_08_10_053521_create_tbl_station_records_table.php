...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_station_records', function (Blueprint $table) {
            ...
            $table->unique(['server_ip', 'server_sn', 'loop_no', 'start_code', 'date_stamp'], 'uniq_keys');
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_station_records');
    }
};
